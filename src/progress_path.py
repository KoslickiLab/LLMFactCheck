...
PROGRESS_FILES = {
    ...
    'mixtral3': os.path.join('result', 'progress', 'mixtral3_progress.csv'),
    'mixtral3_icl': os.path.join('result', 'progress', 'mixtral3_icl_progress.csv'),
    'mixtral4': os.path.join('result', 'progress', 'mixtral4_progress.csv'),
    'mixtral4_icl': os.path.join('result', 'progress', 'mixtral4_icl_progress.csv'),
    'mixtral5': os.path.join('result', 'progress', 'mixtral5_progress.csv'),
